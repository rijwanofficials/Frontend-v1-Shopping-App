...
const HomePage = () => {
  ...
  // ✅ Added "Laptops" mapping for backend category filtering
  const categoryMap = {
    Beauty: "beauty",
    Furniture: "furniture",
    Groceries: "groceries",
  ...
  const handleCategoryClick = (label) => {
    ...
    if (dbCategory) {
      ...
      console.warn(`No mapped category found for: ${label}`);
    }
  };
      ...
      <main>
        ...
        <div className="flex flex-wrap gap-6 justify-center items-center p-3 bg-gray-100">
          {[
            ...
            { label: "Women's Dresses", img: fashion2 },
            { label: "Sports Accessories", img: gaming },
            { label: "Motorcycle", img: appliances },
            { label: "Laptops", img: electronicsImg }, // ✅ updated with proper image
          ].map((cat) => (
            <div
              key={cat.label}
              className="w-32 h-32 bg-white flex flex-col justify-center items-center rounded-md cursor-pointer hover:shadow-lg transition hover:scale-105"
        ...
        <div className="bg-blue-600 text-white p-12 text-center mx-6 my-6 rounded-lg">
          ...
          <button
            className="mt-4 bg-white text-blue-600 px-6 py-2 rounded font-medium hover:bg-gray-100 transition"
        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            {[
              ...
              { name: "Laptop Pro", price: "₹49,999", img: laptop },
              { name: "Stylish Jacket", price: "₹2,499", img: fashion2 },
              { name: "Kitchen Set", price: "₹1,999", img: kitchen2 },
            ].map((prod) => (
              <div
                key={prod.name}
        ...
        <div className="bg-yellow-100 p-8 text-center rounded-lg mx-6 my-6">
          ...
          <p className="text-gray-700 mb-4">
            Grab your favorite items before the deal ends.
          </p>
