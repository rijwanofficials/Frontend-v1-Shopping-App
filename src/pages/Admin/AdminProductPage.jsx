...
return (
  <div className="max-w-screen-xl w-full min-h-screen mx-auto px-2 py-4">
    {/* Heading at the top */}
    <h1 className="text-3xl font-bold text-blue-700 mb-6">All Products</h1>
        ...
        <div className="flex flex-col gap-4">
          {products?.map((elem) => (
            <div
              ...
              onClick={editProductId === elem._id ? undefined : () => handleViewProduct(elem._id)}
            >
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                <div className="w-full sm:w-40 h-48 sm:h-40 flex-shrink-0 flex items-center justify-center overflow-hidden rounded-md">
                  <img
                    src={elem.images?.[0] || ""}
                    alt={elem.title}
                ...
                <div className="flex-1 flex flex-col gap-2 min-h-[128px]">
                  {editProductId === elem._id ? (
                    <form className="flex flex-col gap-2 flex-1" onSubmit={handleSave}>
                    ...
                    <div className="flex flex-col justify-between flex-1">
                      <div className="flex flex-col gap-1">
                        <h2 className="font-bold text-fuchsia-500 line-clamp-2">{elem.title}</h2>
                        <p>Rs. {elem.price}</p>
